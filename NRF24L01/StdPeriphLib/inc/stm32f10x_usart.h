...
typedef struct
{
    ...
    uint16_t USART_Parity; /*!< Specifies the parity mode.
                                 ...
                                 transmitted data (9th bit when the word length
                                 is set to 9 data bits; 8th bit when the word
...
typedef struct
{
    uint16_t USART_Clock; /*!< Specifies whether the USART clock is enabled
    ...
    uint16_t USART_CPHA; /*!< Specifies the clock transition on which the
                               bit capture is made. This parameter can be a
                               value of @ref USART_Clock_Phase */
