...
typedef struct
{
   ...
   uint32_t DAC_WaveGeneration; /*!< Specifies whether DAC channel noise waves
                                  ...
                                  no wave is generated. This parameter can be a
...
#   define DAC_Trigger_T8_TRGO \
      ((uint32_t)0x0000000C) /*!< TIM8 TRGO selected as external conversion \ \ \
                                  trigger for DAC channel \ \ only in            \ \
                                  High-density \ devices*/
#   define DAC_Trigger_T3_TRGO \
      ((uint32_t)0x0000000C) /*!< TIM8 TRGO selected as external conversion \ \ \
                                  trigger for DAC channel \ \ only in            \ \
                                  Connectivity \ \ \
                                  line, Medium-density and Low-density Value     \ \
                                  Line    \ devices */
...
#   define DAC_Trigger_T15_TRGO \
      ((uint32_t)0x0000001C) /*!< TIM15 TRGO selected as external conversion \ \ \
                                  trigger for DAC channel \ \ \ \ \
                                    only in Medium-density and Low-density Value \ \
                                  \ Line devices*/
...
#   define IS_DAC_TRIGGER(TRIGGER) \
      (((TRIGGER) == DAC_Trigger_None) || ((TRIGGER) == DAC_Trigger_T6_TRGO) || ((TRIGGER) == DAC_Trigger_T8_TRGO) || \
       ((TRIGGER) == DAC_Trigger_T7_TRGO) || ((TRIGGER) == DAC_Trigger_T5_TRGO) || \
