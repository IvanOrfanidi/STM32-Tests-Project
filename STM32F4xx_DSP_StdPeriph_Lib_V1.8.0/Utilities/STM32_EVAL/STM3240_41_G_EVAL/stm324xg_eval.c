...
void sEE_LowLevel_Init(void)
{
    ...
    DMA_ClearFlag(sEE_I2C_DMA_STREAM_TX, sEE_TX_DMA_FLAG_FEIF | sEE_TX_DMA_FLAG_DMEIF | sEE_TX_DMA_FLAG_TEIF | sEE_TX_DMA_FLAG_HTIF | sEE_TX_DMA_FLAG_TCIF);
    ...
    /* Clear any pending flag on Rx Stream */
    DMA_ClearFlag(sEE_I2C_DMA_STREAM_RX, sEE_RX_DMA_FLAG_FEIF | sEE_RX_DMA_FLAG_DMEIF | sEE_RX_DMA_FLAG_TEIF | sEE_RX_DMA_FLAG_HTIF | sEE_RX_DMA_FLAG_TCIF);
