...
/* key = "The hash processor is a fully compliant implementation of the secure
  ...
  */
const uint8_t Key[KEY_TAB_SIZE] = {  };
...
==============================================================================*/
    ...
    /* HMAC SHA-1 Digest Computation */
    HMAC_SHA1((uint8_t*)Key, KEY_TAB_SIZE, (uint8_t*)Input, INPUT_TAB_SIZE, Sha1output);
...
==============================================================================*/
    ...
    /* HMAC MD5 Digest Computation */
    HMAC_MD5((uint8_t*)Key, KEY_TAB_SIZE, (uint8_t*)Input, INPUT_TAB_SIZE, Md5output);
...
static void Display_SHA1Digest(void)
{
    ...
    printf(" ---------------------------------------\n\r");
    printf(" H0 = [0x%02x%02x%02x%02x]  \n\r", Sha1output[0], Sha1output[1], Sha1output[2], Sha1output[3]);
    printf(" H1 = [0x%02x%02x%02x%02x]  \n\r", Sha1output[4], Sha1output[5], Sha1output[6], Sha1output[7]);
    printf(" H2 = [0x%02x%02x%02x%02x]  \n\r", Sha1output[8], Sha1output[9], Sha1output[10], Sha1output[11]);
    printf(" H3 = [0x%02x%02x%02x%02x]  \n\r", Sha1output[12], Sha1output[13], Sha1output[14], Sha1output[15]);
    printf(" H4 = [0x%02x%02x%02x%02x]  \n\r", Sha1output[16], Sha1output[17], Sha1output[18], Sha1output[19]);
}
...
static void Display_MD5Digest(void)
{
    ...
    printf(" ---------------------------------------\n\r");
    printf(" A = [0x%02x%02x%02x%02x]  \n\r", Md5output[0], Md5output[1], Md5output[2], Md5output[3]);
    printf("\r B = [0x%02x%02x%02x%02x]  \n", Md5output[4], Md5output[5], Md5output[6], Md5output[7]);
    printf("\r C = [0x%02x%02x%02x%02x]  \n", Md5output[8], Md5output[9], Md5output[10], Md5output[11]);
    printf("\r D = [0x%02x%02x%02x%02x]  \n", Md5output[12], Md5output[13], Md5output[14], Md5output[15]);
}
