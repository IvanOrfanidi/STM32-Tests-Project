...
static void Display_MD5Digest(void)
{
    ...
    printf(" B = [0x%02x%02x%02x%02x]  \n\r", Md5output[4], Md5output[5], Md5output[6], Md5output[7]);
    printf(" C = [0x%02x%02x%02x%02x]  \n\r", Md5output[8], Md5output[9], Md5output[10], Md5output[11]);
    printf(" D = [0x%02x%02x%02x%02x]  \n\r", Md5output[12], Md5output[13], Md5output[14], Md5output[15]);
}
