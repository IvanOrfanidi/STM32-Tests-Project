...
uint8_t AES128key[KEY_SIZE / 8] = { 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f };
uint8_t Nonce[NONCE_SIZE] = { 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17 };
uint32_t NonceSize = NONCE_SIZE;
uint8_t HeaderMessage[HEADER_SIZE] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
uint8_t HBuffer[HEADER_SIZE + 21]; /* Temporary buffer used to append the header.
                                      HBuffer size must be equal to HEADER_SIZE + 21 */
uint8_t PlainText[PLAINTEXT_SIZE] = { 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f };
uint8_t ExpectedCypherText[PLAINTEXT_SIZE] = { 0xd2, 0xa1, 0xf0, 0xe0, 0x51, 0xea, 0x5f, 0x62, 0x08, 0x1a, 0x77, 0x92, 0x07, 0x3d, 0x59, 0x3d };
