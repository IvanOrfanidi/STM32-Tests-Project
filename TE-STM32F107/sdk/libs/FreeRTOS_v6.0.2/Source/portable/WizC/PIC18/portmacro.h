...
\
         ...
         movff STATUS, POSTDEC2 movff WREG, POSTDEC2 movff BSR, POSTDEC2 movff PRODH, POSTDEC2 movff PRODL, \
            POSTDEC2 movff FSR0H, POSTDEC2 movff FSR0L, POSTDEC2 movff FSR1H, POSTDEC2 movff FSR1L, \
            POSTDEC2 movff TABLAT, POSTDEC2 if __ROMSIZE > 0x8000 movff TBLPTRU, POSTDEC2 endif movff TBLPTRH, \
            POSTDEC2 movff TBLPTRL, POSTDEC2 if __ROMSIZE > 0x8000 movff PCLATU, POSTDEC2 endif movff PCLATH, \
            POSTDEC2; \
         ; \
         ...
         stack, too.; \
         movf STKPTR, W, ACCESS bz _rtos_s3 _rtos_S2 : if __ROMSIZE > 0x8000 movff TOSU, POSTDEC2 endif movff TOSH, \
            POSTDEC2 movff TOSL, POSTDEC2 pop tstfsz STKPTR, ACCESS SMARTJUMP _rtos_S2 _rtos_s3 : movwf POSTDEC2, \
                                                                                                  ACCESS; \
         ...
         if \
            ucInterruptForced == portINTERRUPTS_FORCED clrf POSTDEC2, ACCESS else movff ucCriticalNesting, \
               POSTDEC2 endif; \
         ; \
      ...
      { \
		...
		_rtos_R1:													\
         ...
         movlw OVERHEADPAGE0 - LOCOPTSIZE + MAXLOCOPTSIZE movwf FSR0L, ACCESS clrf FSR0H, \
            ACCESS _rtos_R2 : decf FSR0L, F, ACCESS movff PREINC2, INDF0 tstfsz FSR0L, ACCESS SMARTJUMP _rtos_R2; \
         ; \
