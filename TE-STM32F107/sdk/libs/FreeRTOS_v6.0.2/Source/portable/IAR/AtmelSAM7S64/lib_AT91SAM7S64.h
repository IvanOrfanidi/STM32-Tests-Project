...
__inline void AT91F_SSC_CfgPIO(void)
{
   // Configure PIO controllers to periph mode
   AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA,   // PIO controller base address
                       ((unsigned int)AT91C_PA17_TD) | ((unsigned int)AT91C_PA15_TF) | ((unsigned int)AT91C_PA19_RK) |
                          ((unsigned int)AT91C_PA18_RD) | ((unsigned int)AT91C_PA20_RF) |
...
__inline void AT91F_SPI_CfgPIO(void)
{
   ...
   AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA,   // PIO controller base address
                       ...
                       ((unsigned int)AT91C_PA9_NPCS1) | ((unsigned int)AT91C_PA30_NPCS2) |
                          ...
                          ((unsigned int)AT91C_PA3_NPCS3) | ((unsigned int)AT91C_PA5_NPCS3));   // Peripheral B
}
...
__inline void AT91F_US0_CfgPIO(void)
{
   ...
   AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA,   // PIO controller base address
                       ((unsigned int)AT91C_PA5_RXD0) | ((unsigned int)AT91C_PA6_TXD0) |
                          ((unsigned int)AT91C_PA7_RTS0) | ((unsigned int)AT91C_PA8_CTS0),   // Peripheral A
...
{
   AT91F_PMC_EnablePeriphClock(AT91C_BASE_PMC,   // PIO controller base address
                               ((unsigned int)1 << AT91C_ID_IRQ0) | ((unsigned int)1 << AT91C_ID_FIQ) |
