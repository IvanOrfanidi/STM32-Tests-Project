...
FRESULT f_forward(FIL*, uint16_t (*)(const uint8_t*, uint32_t), uint32_t, uint32_t*); /* Forward data to the stream */
...
/* Sync functions */
#if _FS_REENTRANT
_Bool ff_cre_syncobj(uint8_t, _SYNC_t*);
_Bool ff_del_syncobj(_SYNC_t);
_Bool ff_req_grant(_SYNC_t);
