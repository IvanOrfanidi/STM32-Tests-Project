...
#      define ENTR_CRT_SECTION() taskENTER_CRITICAL()
#      define EXT_CRT_SECTION() taskEXIT_CRITICAL()
#   endif

#   define LongToBin(n) \
      (((n >> 21) & 0x80) | ((n >> 18) & 0x40) | ((n >> 15) & 0x20) | ((n >> 12) & 0x10) | ((n >> 9) & 0x08) | \
...
#   define BIN32(b1, b2, b3, b4) \
      ((((Int32U)__BIN(b1)) << 24UL) + (((Int32U)__BIN(b2)) << 16UL) + (((Int32U)__BIN(b3)) << 8UL) + (Int32U)__BIN(b4))
