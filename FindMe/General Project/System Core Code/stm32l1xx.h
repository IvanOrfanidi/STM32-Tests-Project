...
#define __STM32L1XX_STDPERIPH_VERSION \
    ((__STM32L1XX_STDPERIPH_VERSION_MAIN << 24) | (__STM32L1XX_STDPERIPH_VERSION_SUB1 << 16) | \
        (__STM32L1XX_STDPERIPH_VERSION_SUB2 << 8) | (__STM32L1XX_STDPERIPH_VERSION_RC))
...
#define ADC_CR2_JEXTEN \
    ((uint32_t)0x00300000)                      /*!< JEXTEN[1:0] bits (External Trigger Conversion mode for injected channels) */
...
#define ADC_CR2_EXTEN \
    ((uint32_t)0x30000000)                     /*!< EXTEN[1:0] bits (External Trigger Conversion mode for regular channels) */
...
#define RCC_APB2LPENR_SYSCFGLPEN \
    ((uint32_t)0x00000001)                              /*!< System Configuration SYSCFG clock enabled in sleep mode */
...
#define RCC_CSR_RTCSEL_HSE \
    ((uint32_t)0x00030000) /*!< HSE oscillator clock divided by 2, 4, 8 or 16 by RTCPRE used as RTC clock */
