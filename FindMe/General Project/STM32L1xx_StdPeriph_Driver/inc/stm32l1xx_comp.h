...
#define IS_COMP_INVERTING_INPUT(INPUT) \
    (((INPUT) == COMP_InvertingInput_None) || ((INPUT) == COMP_InvertingInput_IO) || \
        ((INPUT) == COMP_InvertingInput_VREFINT) || ((INPUT) == COMP_InvertingInput_3_4VREFINT) || \
        ((INPUT) == COMP_InvertingInput_1_2VREFINT) || ((INPUT) == COMP_InvertingInput_1_4VREFINT) || \
        ((INPUT) == COMP_InvertingInput_DAC1) || ((INPUT) == COMP_InvertingInput_DAC2))
/**
 * @}
 */
...
#define IS_COMP_OUTPUT(OUTPUT) \
    (((OUTPUT) == COMP_OutputSelect_TIM2IC4) || ((OUTPUT) == COMP_OutputSelect_TIM2OCREFCLR) || \
        ((OUTPUT) == COMP_OutputSelect_TIM3IC4) || ((OUTPUT) == COMP_OutputSelect_TIM3OCREFCLR) || \
        ((OUTPUT) == COMP_OutputSelect_TIM4IC4) || ((OUTPUT) == COMP_OutputSelect_TIM4OCREFCLR) || \
