...
#   define IS_GPIO_ALL_PERIPH(PERIPH) \
      (((PERIPH) == GPIOA) || ((PERIPH) == GPIOB) || ((PERIPH) == GPIOC) || ((PERIPH) == GPIOD) || \
       ((PERIPH) == GPIOE) || ((PERIPH) == GPIOH) || ((PERIPH) == GPIOF) || ((PERIPH) == GPIOG))
...
#   define IS_GPIO_SPEED(SPEED) \
      (((SPEED) == GPIO_Speed_400KHz) || ((SPEED) == GPIO_Speed_2MHz) || ((SPEED) == GPIO_Speed_10MHz) || \
...
#   define IS_GPIO_AF(AF) \
      (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_MCO) || ((AF) == GPIO_AF_RTC_AF1) || ((AF) == GPIO_AF_WKUP) || \
       ((AF) == GPIO_AF_SWJ) || ((AF) == GPIO_AF_TRACE) || ((AF) == GPIO_AF_TIM2) || ((AF) == GPIO_AF_TIM3) || \
       ((AF) == GPIO_AF_TIM4) || ((AF) == GPIO_AF_TIM9) || ((AF) == GPIO_AF_TIM10) || ((AF) == GPIO_AF_TIM11) || \
       ((AF) == GPIO_AF_I2C1) || ((AF) == GPIO_AF_I2C2) || ((AF) == GPIO_AF_SPI1) || ((AF) == GPIO_AF_SPI2) || \
       ((AF) == GPIO_AF_USART1) || ((AF) == GPIO_AF_USART2) || ((AF) == GPIO_AF_USART3) || ((AF) == GPIO_AF_USB) || \
       ((AF) == GPIO_AF_LCD) || ((AF) == GPIO_AF_RI) || ((AF) == GPIO_AF_TIM5) || ((AF) == GPIO_AF_SPI3) || \
       ((AF) == GPIO_AF_UART4) || ((AF) == GPIO_AF_UART5) || ((AF) == GPIO_AF_FSMC) || ((AF) == GPIO_AF_SDIO) || \
       ((AF) == GPIO_AF_EVENTOUT))
