...
#   define IS_RTC_BKP(BKP) \
      (((BKP) == RTC_BKP_DR0) || ((BKP) == RTC_BKP_DR1) || ((BKP) == RTC_BKP_DR2) || ((BKP) == RTC_BKP_DR3) || \
       ...
       ((BKP) == RTC_BKP_DR20) || ((BKP) == RTC_BKP_DR21) || ((BKP) == RTC_BKP_DR22) || ((BKP) == RTC_BKP_DR23) || \
       ((BKP) == RTC_BKP_DR24) || ((BKP) == RTC_BKP_DR25) || ((BKP) == RTC_BKP_DR26) || ((BKP) == RTC_BKP_DR27) || \
       ((BKP) == RTC_BKP_DR28) || ((BKP) == RTC_BKP_DR29) || ((BKP) == RTC_BKP_DR30) || ((BKP) == RTC_BKP_DR31))
/**
 * @}
 */
...
#   define IS_RTC_GET_FLAG(FLAG) \
      (((FLAG) == RTC_FLAG_TSOVF) || ((FLAG) == RTC_FLAG_TSF) || ((FLAG) == RTC_FLAG_WUTF) || \
       ...
       ((FLAG) == RTC_FLAG_ALRAWF) || ((FLAG) == RTC_FLAG_TAMP1F) || ((FLAG) == RTC_FLAG_TAMP2F) || \
       ((FLAG) == RTC_FLAG_TAMP3F) || ((FLAG) == RTC_FLAG_RECALPF) || ((FLAG) == RTC_FLAG_SHPF) || \
       ((FLAG) == RTC_FLAG_INITS))
...
#   define IS_RTC_GET_IT(IT) \
      (((IT) == RTC_IT_TS) || ((IT) == RTC_IT_WUT) || ((IT) == RTC_IT_ALRB) || ((IT) == RTC_IT_ALRA) || \
       ((IT) == RTC_IT_TAMP1) || ((IT) == RTC_IT_TAMP2) || ((IT) == RTC_IT_TAMP3))
