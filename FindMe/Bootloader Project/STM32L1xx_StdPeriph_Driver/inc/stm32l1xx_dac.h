...
#define DAC_Trigger_T9_TRGO \
    ((uint32_t)0x0000001C) /*!< TIM9 TRGO selected as external conversion trigger for DAC channel */
...
#define IS_DAC_TRIGGER(TRIGGER) \
    (((TRIGGER) == DAC_Trigger_None) || ((TRIGGER) == DAC_Trigger_T6_TRGO) || ((TRIGGER) == DAC_Trigger_T7_TRGO) || \
        ((TRIGGER) == DAC_Trigger_T9_TRGO) || ((TRIGGER) == DAC_Trigger_T2_TRGO) || \
