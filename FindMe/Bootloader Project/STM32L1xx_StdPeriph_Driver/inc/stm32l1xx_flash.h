...
#   define IS_OB_BOR_LEVEL(LEVEL) \
      (((LEVEL) == OB_BOR_OFF) || ((LEVEL) == OB_BOR_LEVEL1) || ((LEVEL) == OB_BOR_LEVEL2) || \
       ((LEVEL) == OB_BOR_LEVEL3) || ((LEVEL) == OB_BOR_LEVEL4) || ((LEVEL) == OB_BOR_LEVEL5))
...
#   define IS_FLASH_GET_FLAG(FLAG) \
      (((FLAG) == FLASH_FLAG_BSY) || ((FLAG) == FLASH_FLAG_EOP) || ((FLAG) == FLASH_FLAG_ENDHV) || \
       ((FLAG) == FLASH_FLAG_READY) || ((FLAG) == FLASH_FLAG_WRPERR) || ((FLAG) == FLASH_FLAG_PGAERR) || \
       ((FLAG) == FLASH_FLAG_SIZERR) || ((FLAG) == FLASH_FLAG_OPTVERR) || ((FLAG) == FLASH_FLAG_OPTVERRUSR) || \
       ((FLAG) == FLASH_FLAG_RDERR))
/**
 * @}
 */
