...
#define IS_LCD_PRESCALER(PRESCALER) \
    (((PRESCALER) == LCD_Prescaler_1) || ((PRESCALER) == LCD_Prescaler_2) || ((PRESCALER) == LCD_Prescaler_4) || \
        ((PRESCALER) == LCD_Prescaler_8) || ((PRESCALER) == LCD_Prescaler_16) || ((PRESCALER) == LCD_Prescaler_32) || \
        ((PRESCALER) == LCD_Prescaler_64) || ((PRESCALER) == LCD_Prescaler_128) || \
        ((PRESCALER) == LCD_Prescaler_256) || ((PRESCALER) == LCD_Prescaler_512) || \
        ((PRESCALER) == LCD_Prescaler_1024) || ((PRESCALER) == LCD_Prescaler_2048) || \
        ((PRESCALER) == LCD_Prescaler_4096) || ((PRESCALER) == LCD_Prescaler_8192) || \
        ((PRESCALER) == LCD_Prescaler_16384) || ((PRESCALER) == LCD_Prescaler_32768))
...
#define IS_LCD_DIVIDER(DIVIDER) \
    (((DIVIDER) == LCD_Divider_16) || ((DIVIDER) == LCD_Divider_17) || ((DIVIDER) == LCD_Divider_18) || \
        ((DIVIDER) == LCD_Divider_19) || ((DIVIDER) == LCD_Divider_20) || ((DIVIDER) == LCD_Divider_21) || \
        ((DIVIDER) == LCD_Divider_22) || ((DIVIDER) == LCD_Divider_23) || ((DIVIDER) == LCD_Divider_24) || \
        ((DIVIDER) == LCD_Divider_25) || ((DIVIDER) == LCD_Divider_26) || ((DIVIDER) == LCD_Divider_27) || \
        ((DIVIDER) == LCD_Divider_28) || ((DIVIDER) == LCD_Divider_29) || ((DIVIDER) == LCD_Divider_30) || \
...
#define IS_LCD_DUTY(DUTY) \
    (((DUTY) == LCD_Duty_Static) || ((DUTY) == LCD_Duty_1_2) || ((DUTY) == LCD_Duty_1_3) || \
        ((DUTY) == LCD_Duty_1_4) || ((DUTY) == LCD_Duty_1_8))
...
#define IS_LCD_PULSE_ON_DURATION(DURATION) \
    (((DURATION) == LCD_PulseOnDuration_0) || ((DURATION) == LCD_PulseOnDuration_1) || \
        ((DURATION) == LCD_PulseOnDuration_2) || ((DURATION) == LCD_PulseOnDuration_3) || \
        ((DURATION) == LCD_PulseOnDuration_4) || ((DURATION) == LCD_PulseOnDuration_5) || \
        ((DURATION) == LCD_PulseOnDuration_6) || ((DURATION) == LCD_PulseOnDuration_7))
/**
 * @}
 */
...
#define IS_LCD_DEAD_TIME(TIME) \
    (((TIME) == LCD_DeadTime_0) || ((TIME) == LCD_DeadTime_1) || ((TIME) == LCD_DeadTime_2) || \
        ((TIME) == LCD_DeadTime_3) || ((TIME) == LCD_DeadTime_4) || ((TIME) == LCD_DeadTime_5) || \
...
#define IS_LCD_BLINK_MODE(MODE) \
    (((MODE) == LCD_BlinkMode_Off) || ((MODE) == LCD_BlinkMode_SEG0_COM0) || \
        ((MODE) == LCD_BlinkMode_SEG0_AllCOM) || ((MODE) == LCD_BlinkMode_AllSEG_AllCOM))
/**
 * @}
 */
...
#define IS_LCD_BLINK_FREQUENCY(FREQUENCY) \
    (((FREQUENCY) == LCD_BlinkFrequency_Div8) || ((FREQUENCY) == LCD_BlinkFrequency_Div16) || \
        ((FREQUENCY) == LCD_BlinkFrequency_Div32) || ((FREQUENCY) == LCD_BlinkFrequency_Div64) || \
        ((FREQUENCY) == LCD_BlinkFrequency_Div128) || ((FREQUENCY) == LCD_BlinkFrequency_Div256) || \
...
#define IS_LCD_CONTRAST(CONTRAST) \
    (((CONTRAST) == LCD_Contrast_Level_0) || ((CONTRAST) == LCD_Contrast_Level_1) || \
        ((CONTRAST) == LCD_Contrast_Level_2) || ((CONTRAST) == LCD_Contrast_Level_3) || \
        ((CONTRAST) == LCD_Contrast_Level_4) || ((CONTRAST) == LCD_Contrast_Level_5) || \
        ((CONTRAST) == LCD_Contrast_Level_6) || ((CONTRAST) == LCD_Contrast_Level_7))
/**
 * @}
 */
...
#define IS_LCD_GET_FLAG(FLAG) \
    (((FLAG) == LCD_FLAG_ENS) || ((FLAG) == LCD_FLAG_SOF) || ((FLAG) == LCD_FLAG_UDR) || ((FLAG) == LCD_FLAG_UDD) || \
...
#define IS_LCD_RAM_REGISTER(REGISTER) \
    (((REGISTER) == LCD_RAMRegister_0) || ((REGISTER) == LCD_RAMRegister_1) || ((REGISTER) == LCD_RAMRegister_2) || \
        ((REGISTER) == LCD_RAMRegister_3) || ((REGISTER) == LCD_RAMRegister_4) || ((REGISTER) == LCD_RAMRegister_5) || \
        ((REGISTER) == LCD_RAMRegister_6) || ((REGISTER) == LCD_RAMRegister_7) || ((REGISTER) == LCD_RAMRegister_8) || \
        ((REGISTER) == LCD_RAMRegister_9) || ((REGISTER) == LCD_RAMRegister_10) || \
        ((REGISTER) == LCD_RAMRegister_11) || ((REGISTER) == LCD_RAMRegister_12) || \
        ((REGISTER) == LCD_RAMRegister_13) || ((REGISTER) == LCD_RAMRegister_14) || ((REGISTER) == LCD_RAMRegister_15))
