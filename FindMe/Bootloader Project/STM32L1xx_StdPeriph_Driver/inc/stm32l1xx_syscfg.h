...
#define IS_SYSCFG_MEMORY_REMAP_CONFING(REMAP) \
    (((REMAP) == SYSCFG_MemoryRemap_Flash) || ((REMAP) == SYSCFG_MemoryRemap_SystemFlash) || \
        ((REMAP) == SYSCFG_MemoryRemap_FSMC) || ((REMAP) == SYSCFG_MemoryRemap_SRAM))
...
#define IS_RI_RESISTOR(RESISTOR) \
    (((RESISTOR) == COMP_CSR_10KPU) || ((RESISTOR) == COMP_CSR_400KPU) || ((RESISTOR) == COMP_CSR_10KPD) || \
...
#define IS_RI_CHANNEL(CHANNEL) \
    (((CHANNEL) == RI_Channel_3) || ((CHANNEL) == RI_Channel_8) || ((CHANNEL) == RI_Channel_13))
...
#define IS_RI_INPUTCAPTURE(INPUTCAPTURE) \
    ((((INPUTCAPTURE) & (uint32_t)0xFFC2FFFF) == 0x00) && ((INPUTCAPTURE) != (uint32_t)0x00))
/**
 * @}
 */
...
#define IS_RI_TIM(TIM) \
    (((TIM) == TIM_Select_None) || ((TIM) == TIM_Select_TIM2) || ((TIM) == TIM_Select_TIM3) || \
        ((TIM) == TIM_Select_TIM4))
...
#define IS_RI_INPUTCAPTURE_ROUTING(ROUTING) \
    (((ROUTING) == RI_InputCaptureRouting_0) || ((ROUTING) == RI_InputCaptureRouting_1) || \
        ((ROUTING) == RI_InputCaptureRouting_2) || ((ROUTING) == RI_InputCaptureRouting_3) || \
        ((ROUTING) == RI_InputCaptureRouting_4) || ((ROUTING) == RI_InputCaptureRouting_5) || \
        ((ROUTING) == RI_InputCaptureRouting_6) || ((ROUTING) == RI_InputCaptureRouting_7) || \
        ((ROUTING) == RI_InputCaptureRouting_8) || ((ROUTING) == RI_InputCaptureRouting_9) || \
        ((ROUTING) == RI_InputCaptureRouting_10) || ((ROUTING) == RI_InputCaptureRouting_11) || \
        ((ROUTING) == RI_InputCaptureRouting_12) || ((ROUTING) == RI_InputCaptureRouting_13) || \
        ((ROUTING) == RI_InputCaptureRouting_14) || ((ROUTING) == RI_InputCaptureRouting_15))
...
#define IS_RI_IOSWITCH(IOSWITCH) \
    (((IOSWITCH) == RI_IOSwitch_CH0) || ((IOSWITCH) == RI_IOSwitch_CH1) || ((IOSWITCH) == RI_IOSwitch_CH2) || \
        ((IOSWITCH) == RI_IOSwitch_CH3) || ((IOSWITCH) == RI_IOSwitch_CH4) || ((IOSWITCH) == RI_IOSwitch_CH5) || \
        ((IOSWITCH) == RI_IOSwitch_CH6) || ((IOSWITCH) == RI_IOSwitch_CH7) || ((IOSWITCH) == RI_IOSwitch_CH8) || \
        ((IOSWITCH) == RI_IOSwitch_CH9) || ((IOSWITCH) == RI_IOSwitch_CH10) || ((IOSWITCH) == RI_IOSwitch_CH11) || \
        ((IOSWITCH) == RI_IOSwitch_CH12) || ((IOSWITCH) == RI_IOSwitch_CH13) || ((IOSWITCH) == RI_IOSwitch_CH14) || \
        ((IOSWITCH) == RI_IOSwitch_CH15) || ((IOSWITCH) == RI_IOSwitch_CH18) || ((IOSWITCH) == RI_IOSwitch_CH19) || \
        ((IOSWITCH) == RI_IOSwitch_CH20) || ((IOSWITCH) == RI_IOSwitch_CH21) || ((IOSWITCH) == RI_IOSwitch_CH22) || \
        ((IOSWITCH) == RI_IOSwitch_CH23) || ((IOSWITCH) == RI_IOSwitch_CH24) || ((IOSWITCH) == RI_IOSwitch_CH25) || \
        ((IOSWITCH) == RI_IOSwitch_VCOMP) || ((IOSWITCH) == RI_IOSwitch_CH27) || ((IOSWITCH) == RI_IOSwitch_CH28) || \
        ((IOSWITCH) == RI_IOSwitch_CH29) || ((IOSWITCH) == RI_IOSwitch_CH30) || ((IOSWITCH) == RI_IOSwitch_CH31) || \
        ((IOSWITCH) == RI_IOSwitch_GR10_1) || ((IOSWITCH) == RI_IOSwitch_GR10_2) || \
        ((IOSWITCH) == RI_IOSwitch_GR10_3) || ((IOSWITCH) == RI_IOSwitch_GR10_4) || \
        ((IOSWITCH) == RI_IOSwitch_GR6_1) || ((IOSWITCH) == RI_IOSwitch_GR6_2) || ((IOSWITCH) == RI_IOSwitch_GR6_3) || \
        ((IOSWITCH) == RI_IOSwitch_GR6_4) || ((IOSWITCH) == RI_IOSwitch_GR5_1) || ((IOSWITCH) == RI_IOSwitch_GR5_2) || \
        ((IOSWITCH) == RI_IOSwitch_GR5_3) || ((IOSWITCH) == RI_IOSwitch_GR5_4) || ((IOSWITCH) == RI_IOSwitch_GR4_1) || \
        ((IOSWITCH) == RI_IOSwitch_GR4_2) || ((IOSWITCH) == RI_IOSwitch_GR4_3) || ((IOSWITCH) == RI_IOSwitch_GR4_4) || \
        ((IOSWITCH) == RI_IOSwitch_CH0b) || ((IOSWITCH) == RI_IOSwitch_CH1b) || ((IOSWITCH) == RI_IOSwitch_CH2b) || \
        ((IOSWITCH) == RI_IOSwitch_CH3b) || ((IOSWITCH) == RI_IOSwitch_CH6b) || ((IOSWITCH) == RI_IOSwitch_CH7b) || \
        ((IOSWITCH) == RI_IOSwitch_CH8b) || ((IOSWITCH) == RI_IOSwitch_CH9b) || ((IOSWITCH) == RI_IOSwitch_CH10b) || \
        ((IOSWITCH) == RI_IOSwitch_CH11b) || ((IOSWITCH) == RI_IOSwitch_CH12b))
...
#define IS_RI_PORT(PORT) \
    (((PORT) == RI_PortA) || ((PORT) == RI_PortB) || ((PORT) == RI_PortC) || ((PORT) == RI_PortD) || \
        ((PORT) == RI_PortE) || ((PORT) == RI_PortF) || ((PORT) == RI_PortG))
/**
 * @}
 */
