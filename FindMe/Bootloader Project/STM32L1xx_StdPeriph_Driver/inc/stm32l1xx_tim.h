...
#   define IS_TIM_ALL_PERIPH(PERIPH) \
      (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM6) || \
       ((PERIPH) == TIM7) || ((PERIPH) == TIM9) || ((PERIPH) == TIM10) || ((PERIPH) == TIM11))

/* LIST1: TIM2, TIM3, TIM4, TIM5, TIM9, TIM10 and TIM11 */
#   define IS_TIM_LIST1_PERIPH(PERIPH) \
      (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM9) || \
       ((PERIPH) == TIM10) || ((PERIPH) == TIM11))

/* LIST3: TIM2, TIM3, TIM4 and TIM5 */
#   define IS_TIM_LIST3_PERIPH(PERIPH) \
      (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5))
...
#   define IS_TIM_LIST6_PERIPH(PERIPH) \
      (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM9) || ((PERIPH) == TIM10) || ((PERIPH) == TIM11))
...
#   define IS_TIM_GET_FLAG(FLAG) \
      (((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) || \
       ((FLAG) == TIM_FLAG_CC3) || ((FLAG) == TIM_FLAG_CC4) || ((FLAG) == TIM_FLAG_Trigger) || \
...
#   define IS_TIM_REMAP(TIM_REMAP) \
      (((TIM_REMAP) == TIM2_TIM10_OC) || ((TIM_REMAP) == TIM2_TIM5_TRGO) || ((TIM_REMAP) == TIM3_TIM11_OC) || \
       ((TIM_REMAP) == TIM3_TIM5_TRGO) || ((TIM_REMAP) == TIM9_GPIO) || ((TIM_REMAP) == TIM9_LSE) || \
       ((TIM_REMAP) == TIM9_TIM3_TRGO) || ((TIM_REMAP) == TIM9_TS_IO) || ((TIM_REMAP) == TIM10_GPIO) || \
       ((TIM_REMAP) == TIM10_LSI) || ((TIM_REMAP) == TIM10_LSE) || ((TIM_REMAP) == TIM10_RTC) || \
       ((TIM_REMAP) == TIM10_RI) || ((TIM_REMAP) == TIM10_ETR_LSE) || ((TIM_REMAP) == TIM10_ETR_TIM9_TRGO) || \
       ((TIM_REMAP) == TIM11_GPIO) || ((TIM_REMAP) == TIM11_MSI) || ((TIM_REMAP) == TIM11_HSE_RTC) || \
       ((TIM_REMAP) == TIM11_RI) || ((TIM_REMAP) == TIM11_ETR_LSE) || ((TIM_REMAP) == TIM11_ETR_TIM9_TRGO))
