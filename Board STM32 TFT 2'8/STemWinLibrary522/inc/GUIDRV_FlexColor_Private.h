...
struct DRIVER_CONTEXT {
    ...
    U16 (*pfReadPixel_16bpp_B16)
    (DRIVER_CONTEXT* _pContext);
    U16 (*pfReadPixel_16bpp_B8)
    (DRIVER_CONTEXT* _pContext);
    U32 (*pfReadPixel_18bpp_B9)
    (DRIVER_CONTEXT* _pContext);
    U32 (*pfReadPixel_18bpp_B18)
    (DRIVER_CONTEXT* _pContext);
    ...
    //
    U16 (*pfReadPixelCust_16bpp)
    (int LayerIndex);
    U32 (*pfReadPixelCust_18bpp)
    (int LayerIndex);
