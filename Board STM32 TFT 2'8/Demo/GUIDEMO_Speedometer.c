...
GUI_CONST_STORAGE unsigned char acGUI_FontDigit19_0034[133] = {
...
static void _SpeedometerDemo(void)
{
    ...
    // Create devices
    //
    Param.hScale = _CreateScale(R_RING, R_SCALE, R_CHECK, R_DIGIT, R_KNOB, COLOR_SCALE0, COLOR_SCALE1, COLOR_CMARK, COLOR_DIGIT, COLOR_RING0, COLOR_RING1, W_RING0, W_RING1, L_CHECK0, L_CHECK1, YPOS_LABEL);
