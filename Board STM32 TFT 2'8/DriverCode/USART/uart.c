...
void Uart3Isr(void)
{
    ...
    if(USART_GetFlagStatus(USART3, USART_FLAG_TXE) && (USART_GetITStatus(USART3, USART_IT_TXE) == SET)) {
...
Boolean UartInit(UartNum_t Uart, Int32U IrqSlot)
{
    ...
    switch(Uart) {
        case UART_1:
            ...
            USART_ClearFlag(USART1, USART_FLAG_CTS | USART_FLAG_LBD | USART_FLAG_TC | USART_FLAG_RXNE | USART_FLAG_IDLE | USART_FLAG_ORE | USART_FLAG_NE | USART_FLAG_FE | USART_FLAG_PE);
        ...
        case UART_2:
            ...
            USART_ClearFlag(USART2, USART_FLAG_CTS | USART_FLAG_LBD | USART_FLAG_TC | USART_FLAG_RXNE | USART_FLAG_IDLE | USART_FLAG_ORE | USART_FLAG_NE | USART_FLAG_FE | USART_FLAG_PE);
        ...
        case UART_3:
            ...
            USART_ClearFlag(USART3, USART_FLAG_CTS | USART_FLAG_LBD | USART_FLAG_TC | USART_FLAG_RXNE | USART_FLAG_IDLE | USART_FLAG_ORE | USART_FLAG_NE | USART_FLAG_FE | USART_FLAG_PE);
