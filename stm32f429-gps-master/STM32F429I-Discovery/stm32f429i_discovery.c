...
void sEE_LowLevel_Init(void)
{
   ...
   DMA_ClearFlag(sEE_I2C_DMA_STREAM_TX,
                 sEE_TX_DMA_FLAG_FEIF | sEE_TX_DMA_FLAG_DMEIF | sEE_TX_DMA_FLAG_TEIF | sEE_TX_DMA_FLAG_HTIF |
   ...
   ;
   sEEDMA_InitStructure.DMA_DIR =
      DMA_DIR_MemoryToPeripheral; /* This parameter will be configured durig communication */
   ...
   DMA_ClearFlag(sEE_I2C_DMA_STREAM_RX,
                 sEE_RX_DMA_FLAG_FEIF | sEE_RX_DMA_FLAG_DMEIF | sEE_RX_DMA_FLAG_TEIF | sEE_RX_DMA_FLAG_HTIF |
