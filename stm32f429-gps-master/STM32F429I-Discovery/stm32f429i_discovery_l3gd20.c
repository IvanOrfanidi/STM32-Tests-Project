...
void L3GD20_Init(L3GD20_InitTypeDef* L3GD20_InitStruct)
{
   ...
   ctrl4 |=
      (uint8_t)(L3GD20_InitStruct->BlockData_Update | L3GD20_InitStruct->Endianness | L3GD20_InitStruct->Full_Scale);
...
void L3GD20_INT1InterruptConfig(L3GD20_InterruptConfigTypeDef* L3GD20_IntConfigStruct)
{
   ...
   ctrl_cfr |= (uint8_t)(L3GD20_IntConfigStruct->Latch_Request | L3GD20_IntConfigStruct->Interrupt_Axes);
