...
void FMC_NORSRAMInit(FMC_NORSRAMInitTypeDef* FMC_NORSRAMInitStruct)
{
    ...
    FMC_Bank1->BTCR[FMC_NORSRAMInitStruct->FMC_Bank] =
        (uint32_t)FMC_NORSRAMInitStruct->FMC_DataAddressMux | FMC_NORSRAMInitStruct->FMC_MemoryType |
    ...
    if((FMC_NORSRAMInitStruct->FMC_ContinousClock == FMC_CClock_SyncAsync) &&
        ...
        FMC_Bank1->BTCR[FMC_Bank1_NORSRAM1 + 1] =
            (uint32_t)(tmpr | (((FMC_NORSRAMInitStruct->FMC_ReadWriteTimingStruct->FMC_CLKDivision) - 1) << 20));
    }
...
void FMC_PCCARDInit(FMC_PCCARDInitTypeDef* FMC_PCCARDInitStruct)
{
    ...
    FMC_Bank4->PCR4 = (uint32_t)FMC_PCCARDInitStruct->FMC_Waitfeature | FMC_NAND_MemoryDataWidth_16b |
