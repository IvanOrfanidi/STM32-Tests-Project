 ...
 *       _aColProps
 */
static const COL_PROP _aColProps[] = { { "Name", 70, GUI_TA_LEFT, LISTVIEW_CompareText },
...
static const GUI_COLOR _aColor[] = {
   ...
   GUI_WHITE,     GUI_LIGHTGRAY,  GUI_GRAY,     GUI_DARKGRAY,  GUI_BLACK,        GUI_BROWN,
};
...
static void _DemoListview(void)
{
   ...
   hList = LISTVIEW_CreateEx(xSpace,
                             INFO_SIZE_Y + ySpace,
                             LISTVIEW_SIZE_X,
                             ySize - INFO_SIZE_Y - (ySpace << 1),
                             WM_HBKWIN,
                             WM_CF_SHOW,
                             0,
                             GUI_ID_LISTVIEW0);
