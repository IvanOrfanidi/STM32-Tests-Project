...
/** ST Widgets ***/
ST_ANIMATED_ICONVIEW_Handle ST_AnimatedIconView_CreateEx(int x0,
                                                         int y0,
                                                         int xSize,
                                                         int ySize,
                                                         WM_HWIN hParent,
                                                         ...
                                                         int delay,
                                                         int FrameNbr);
ST_ANIMATED_ICONVIEW_Handle ST_AnimatedIconView_CreateUser(int x0,
                                                           int y0,
                                                           int xSize,
                                                           int ySize,
                                                           WM_HWIN hParent,
                                                           ...
                                                           int delay,
                                                           int FrameNbr);
ST_ANIMATED_ICONVIEW_Handle ST_AnimatedIconView_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo,
                                                               WM_HWIN hWinParent,
                                                               int x0,
                                                               int y0,
                                                               WM_CALLBACK* cb,
...
void ST_AnimatedIconView_SetDualTextColor(ST_ANIMATED_ICONVIEW_Handle hObj,
                                          int Index,
                                          GUI_COLOR Color,
                                          GUI_COLOR Color1);
...
int ST_AnimatedIconView_SetIcon(ST_ANIMATED_ICONVIEW_Handle hObj,
                                int Index,
                                const GUI_BITMAP** pOpenBitmap,
                                const GUI_BITMAP** pCloseBitmap,
                                int size,
                                int index);
int ST_AnimatedIconView_AddIcon(ST_ANIMATED_ICONVIEW_Handle hObj,
                                const GUI_BITMAP** pOpenBitmap,
                                const GUI_BITMAP** pCloseBitmap,
                                const char* pText);
...
void ST_CHOOSEFILE_SetButtonBitmaps(int index, const GUI_BITMAP* EnabledBMP, const GUI_BITMAP* DisabledBMP);
