...
#      define MBEDTLS_CTR_DRBG_ENTROPY_LEN \
         48 /**< Amount of entropy used per seed by default (48 with SHA-512, 32 with SHA-256) */
#   else
#      define MBEDTLS_CTR_DRBG_ENTROPY_LEN \
         32 /**< Amount of entropy used per seed by default (48 with SHA-512, 32 with SHA-256) */
#   endif
#endif
