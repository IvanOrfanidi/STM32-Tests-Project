 ...
 */
PRIVILEGED_FUNCTION static BaseType_t prvInsertTimerInActiveList(Timer_t* const pxTimer,
 ...
 */
PRIVILEGED_FUNCTION static void prvInitialiseNewTimer(
...
{
   TickType_t xTimeNow;
   PRIVILEGED_INITIALIZED_DATA static TickType_t xLastTime =
