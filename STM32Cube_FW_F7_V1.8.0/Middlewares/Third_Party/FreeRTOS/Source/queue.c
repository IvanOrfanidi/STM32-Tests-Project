 ...
 * back of the queue.
 */
PRIVILEGED_FUNCTION static BaseType_t prvCopyDataToQueue(Queue_t* const pxQueue,
 ...
 */
PRIVILEGED_FUNCTION static BaseType_t prvNotifyQueueSetContainer(const Queue_t* const pxQueue,
 ...
 */
PRIVILEGED_FUNCTION static void prvInitialiseNewQueue(const UBaseType_t uxQueueLength,
...
#if (configUSE_MUTEXES == 1)
               {
                  if (pxQueue->uxQueueType == queueQUEUE_IS_MUTEX)
                  {
                     ...
                     pxQueue->pxMutexHolder =
                        (int8_t*)pvTaskIncrementMutexHeldCount(); /*lint !e961 Cast is not redundant as TaskHandle_t is
                                                                     a typedef. */
                  }
                  else
                  {
