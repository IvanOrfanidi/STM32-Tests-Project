 ...
 * \ingroup QueueManagement
 */
PRIVILEGED_FUNCTION BaseType_t xQueueGenericSend(QueueHandle_t xQueue,
 ...
 * \ingroup QueueManagement
 */
PRIVILEGED_FUNCTION BaseType_t xQueueGenericReceive(QueueHandle_t xQueue,
                                                    void* const pvBuffer,
                                                    TickType_t xTicksToWait,
 ...
 * \ingroup QueueManagement
 */
PRIVILEGED_FUNCTION BaseType_t xQueueGenericSendFromISR(QueueHandle_t xQueue,
                                                        const void* const pvItemToQueue,
 ...
 * \ingroup QueueManagement
 */
PRIVILEGED_FUNCTION BaseType_t xQueueReceiveFromISR(QueueHandle_t xQueue,
                                                    void* const pvBuffer,
                                                    BaseType_t* const pxHigherPriorityTaskWoken);
...
PRIVILEGED_FUNCTION QueueHandle_t xQueueCreateCountingSemaphore(const UBaseType_t uxMaxCount,
                                                                const UBaseType_t uxInitialCount);
PRIVILEGED_FUNCTION QueueHandle_t xQueueCreateCountingSemaphoreStatic(const UBaseType_t uxMaxCount,
                                                                      const UBaseType_t uxInitialCount,
...
PRIVILEGED_FUNCTION void vQueueAddToRegistry(
   QueueHandle_t xQueue,
 ...
 */
#if (configQUEUE_REGISTRY_SIZE > 0)
PRIVILEGED_FUNCTION const char* pcQueueGetName(
 ...
 */
#if (configSUPPORT_DYNAMIC_ALLOCATION == 1)
PRIVILEGED_FUNCTION QueueHandle_t xQueueGenericCreate(const UBaseType_t uxQueueLength,
 ...
 */
#if (configSUPPORT_STATIC_ALLOCATION == 1)
PRIVILEGED_FUNCTION QueueHandle_t xQueueGenericCreateStatic(const UBaseType_t uxQueueLength,
                                                            const UBaseType_t uxItemSize,
 ...
 */
PRIVILEGED_FUNCTION BaseType_t xQueueRemoveFromSet(QueueSetMemberHandle_t xQueueOrSemaphore,
 ...
 */
PRIVILEGED_FUNCTION QueueSetMemberHandle_t xQueueSelectFromSet(QueueSetHandle_t xQueueSet,
...
PRIVILEGED_FUNCTION void vQueueWaitForMessageRestricted(QueueHandle_t xQueue,
                                                        TickType_t xTicksToWait,
