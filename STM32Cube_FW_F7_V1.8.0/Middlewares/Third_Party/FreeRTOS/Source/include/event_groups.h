...
PRIVILEGED_FUNCTION BaseType_t xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup,
 ...
 */
#if (configUSE_TRACE_FACILITY == 1)
PRIVILEGED_FUNCTION BaseType_t xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup,
                                                         const EventBits_t uxBitsToSet,
