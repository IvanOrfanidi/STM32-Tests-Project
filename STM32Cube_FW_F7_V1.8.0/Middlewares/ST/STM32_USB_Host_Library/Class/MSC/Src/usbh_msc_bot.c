...
USBH_StatusTypeDef USBH_MSC_BOT_Process(USBH_HandleTypeDef* phost, uint8_t lun)
{
   ...
   case BOT_SEND_CBW:
      ...
      USBH_BulkSendData(phost, MSC_Handle->hbot.cbw.data, BOT_CBW_LENGTH, MSC_Handle->OutPipe, 1);
   ...
   case BOT_DATA_IN:
      /* Send first packet */
      USBH_BulkReceiveData(phost, MSC_Handle->hbot.pbuf, MSC_Handle->InEpSize, MSC_Handle->InPipe);
   ...
   case BOT_DATA_OUT:
      ...
      USBH_BulkSendData(phost, MSC_Handle->hbot.pbuf, MSC_Handle->OutEpSize, MSC_Handle->OutPipe, 1);
   ...
   case BOT_RECEIVE_CSW:
      ...
      USBH_BulkReceiveData(phost, MSC_Handle->hbot.csw.data, BOT_CSW_LENGTH, MSC_Handle->InPipe);
