...
#      define IMAGE_CF_MEMDEV \
         (1 << 0)   // Widget uses an internal memory device which speeds up use of compressed images (GIF, JPEG, PNG)
...
IMAGE_Handle IMAGE_CreateUser(int x0,
                              int y0,
                              int xSize,
                              int ySize,
                              WM_HWIN hParent,
                              ...
                              int Id,
                              int NumExtraBytes);
IMAGE_Handle IMAGE_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo,
                                  WM_HWIN hWinParent,
                                  int x0,
                                  int y0,
                                  WM_CALLBACK* cb);
