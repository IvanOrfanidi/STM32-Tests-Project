...
struct DRIVER_CONTEXT
{
   ...
   U16 RegEntryMode;   // Can be used for storing additional configuration bits for 'EntryMode' register which is
   ...
   //
   void (*pfDrawBitmap)(GUI_DEVICE* _pDevice,
                        int _x0,
                        int _y0,
                        int _xsize,
                        int _ysize,
...
void SIM_FlexColor_Config(GUI_DEVICE* pDevice,
                          int Orientation,
                          int xSize,
                          int ySize,
                          int FirstSEG,
