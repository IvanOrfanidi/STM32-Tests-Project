...
struct GUI_DEVICE_API
{
   ...
   // Drawing functions
   //
   void (*pfDrawBitmap)(GUI_DEVICE* pDevice,
                        int x0,
                        int y0,
                        int xsize,
                        int ysize,
...
void (*GUI_SetFuncAlphaBlending(void (*pfAlphaBlending)(LCD_COLOR*, LCD_COLOR*, LCD_COLOR*, U32)))(LCD_COLOR*,
                                                                                                   LCD_COLOR*,
                                                                                                   LCD_COLOR*,
                                                                                                   U32);
...
void GUI_BMP__WriteBitmapHeader(GUI_CALLBACK_VOID_U8_P* pfSerialize,
                                int xSize,
                                int ySize,
                                void* p,
                                int BitsPerPixel,
...
#      define GUI_MAKE_COLOR(ABGR) \
         (((((U32)ABGR) & 0xFF000000ul) ^ 0xFF000000ul) | ((((U32)ABGR) & 0x00FF0000ul) >> 16) | \
          (((U32)ABGR) & 0x0000FF00ul) | ((((U32)ABGR) & 0x000000FFul) << 16))
