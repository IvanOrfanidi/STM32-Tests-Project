...
typedef struct
{
   ...
   FunctionalState ADC_ScanConvMode; /*!< Specifies whether the conversion is performed
   ...
   uint32_t ADC_ExternalTrigConv; /*!< Defines the external trigger used to
   ...
   uint32_t ADC_DataAlign; /*!< Specifies whether the ADC data alignment is
                                  left or right. This parameter can be a value
                                  of @ref ADC_data_align */
