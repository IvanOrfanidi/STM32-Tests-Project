...
typedef struct tskTaskControlBlock {
    ...
    BaseType_t xUsingStaticallyAllocatedStack; /* Set to pdTRUE if the stack is a statically allocated array, and pdFALSE
                                                 if the stack is dynamically allocated. */
#endif
...
BaseType_t xTaskGenericCreate(TaskFunction_t pxTaskCode,
    ...
    const MemoryRegion_t* const xRegions) /*lint !e971 Unqualified char types are allowed for
