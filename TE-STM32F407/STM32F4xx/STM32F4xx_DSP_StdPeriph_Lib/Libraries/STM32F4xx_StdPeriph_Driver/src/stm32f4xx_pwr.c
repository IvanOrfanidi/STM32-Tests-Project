 ...
 *                                                System frequency up to 120 MHz (only for STM32F427x/437x/429x/439x
 * devices)
 * @retval None
 */
 ...
 *            @arg PWR_MainRegulator_LowVoltage: STOP mode with main regulator in low voltage mode (Only STM32F429x/439x
 * devices)
 *            @arg PWR_LowPowerRegulator_LowVoltage: STOP mode with low power regulator in low voltage mode (Only
