...
#   define IS_SAI_BLOCK_PROTOCOL(PROTOCOL) \
      (((PROTOCOL) == SAI_Free_Protocol) || ((PROTOCOL) == SAI_SPDIF_Protocol) || ((PROTOCOL) == SAI_AC97_Protocol))
/**
 * @}
 */
...
#   define IS_SAI_BLOCK_DATASIZE(DATASIZE) \
      (((DATASIZE) == SAI_DataSize_8b) || ((DATASIZE) == SAI_DataSize_10b) || ((DATASIZE) == SAI_DataSize_16b) || \
       ((DATASIZE) == SAI_DataSize_20b) || ((DATASIZE) == SAI_DataSize_24b) || ((DATASIZE) == SAI_DataSize_32b))
/**
 * @}
 */
...
#   define IS_SAI_BLOCK_CONFIG_IT(IT) \
      (((IT) == SAI_IT_OVRUDR) || ((IT) == SAI_IT_MUTEDET) || ((IT) == SAI_IT_WCKCFG) || ((IT) == SAI_IT_FREQ) || \
       ((IT) == SAI_IT_CNRDY) || ((IT) == SAI_IT_AFSDET) || ((IT) == SAI_IT_LFSDET))
/**
 * @}
 */
