                                 ...
                                 TStatWkupPin eStatCurrentWkupPin)
{
   ...
   if (iTimeoutLowBat < (LOW_BAT_TIMEOUT - LOW_BAT_TIMEOUT / 3) && eStatCurrentWkupPin != USB_CONNECT)
   {   //РЈСЂРѕРІРµРЅСЊ РїСЂРё РєРѕС‚РѕСЂРѕРј Р±СѓРґРµРј РёРЅС„РѕСЂРјРёСЂРѕРІР°С‚СЊ Рѕ РЅРёР·РєРѕРј Р·Р°СЂСЏРґРµ РђРљР‘.
      portTickType xLastWakeTimerDelay = xTaskGetTickCount();
