...
#define ETH_MMCRIMR_RGUFM \
    ((uint32_t)0x00020000) /* Mask the interrupt when Rx good unicast frames counter reaches half the maximum \
                                   value */
#define ETH_MMCRIMR_RFAEM \
    ((uint32_t)0x00000040) /* Mask the interrupt when when Rx alignment error counter reaches half the maximum \
                                   value */
