...
class Bme
{
 ...
 private:
   ...
   enum BmeRegisters_t : uint8_t
   {
      ...
      BME280_CALIB = 0x88,              ///< E2PROM calibration data start register
      BME280_HUM_CALIB_H1 = 0xA1,
      BME280_HUM_CALIB_H2_LSB = 0xE1,
      BME280_HUM_CALIB_H2_MSB = 0xE2,

      BME280_HUM_CALIB_H3 = 0xE3,
      BME280_HUM_CALIB_H4_MSB = 0xE4,
      BME280_HUM_CALIB_H4_LSB = 0xE5,
      BME280_HUM_CALIB_H5_MSB = 0xE5,
      BME280_HUM_CALIB_H5_LSB = 0xE6,
